...
async function getDriveToken() {
  const sa = {
    client_email: 'vallore-drive@proyecto-vallore-n8n.iam.gserviceaccount.com',
    private_key: '-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n'
  };
  if(!sa.client_email) return null;
...
async function driveUploadExcel(token, folderId, filename, buffer) {
  ...
  const sr = await fetch(`https://www.googleapis.com/drive/v3/files?q=${q}&fields=files(id)&supportsAllDrives=true&includeItemsFromAllDrives=true`, {
    headers: { Authorization: `Bearer ${token}` }
  });
  ...
  if(sd.files && sd.files.length > 0) {
    ...
    url = `https://www.googleapis.com/upload/drive/v3/files/${sd.files[0].id}?uploadType=multipart&supportsAllDrives=true`;
    method = 'PATCH';
  } else {
...
async function generarYSubirExcel(salonNombre, locationId, year, month, data) {
  if(!DRIVE_FOLDER_ID || !process.env.GOOGLE_SERVICE_ACCOUNT) return;
  try {
